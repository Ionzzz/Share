        ...
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="blog.html">最新 <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="single.jsp">话题 <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link " href="#" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">发布</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" id="dropdownMenuButton3" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">关于我们<span class="sr-only">(current)</span></a>

                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="Contact_us.html">联系我们 <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
...
<div class="col-12 py-3 text-center"> <a href="#" class="btn contact_btn">发布</a> </div>
<div id="btns">
    <div>
