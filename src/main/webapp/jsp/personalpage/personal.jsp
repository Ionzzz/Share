                        ...
                        <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                            <nav class="stroke">
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="personal.jsp"><i class="home"></i>我的主页</a></li>
            ...
            <div class="col-xs-9 banner-body-right">
                <div class="msg-text">
                    <div class="col-xs-2 msg-text-left">
                        <p>能量等级</p>
                        <img src="../../images/personal-images/等级图标.jpg" style="height:40px; width:40px">
                    </div>
                    <div class="col-xs-10 msg-text-right">
                        <P>&nbsp;个人资料完善度&nbsp;&nbsp;<span style="font-weight:bold">%75</span></P>
                        <img src="../../images/personal-images/完善条.png">
                        <br/>
