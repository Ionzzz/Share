...
<div class="container">
    <div class="all row banner-body-content">
                    ...
                    <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                        <nav class="stroke">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="thrums_up.jsp" class="hvr-underline-from-left"><span class="iconfont icon-shoucang2"></span>&nbsp;赞</a></li>
        ...
        <div class="center col-md-5">
            <br/>
            <table class="table">
                <th style="text-align:center">收到的赞</th>
                ...
                <tr>
                    <td>
                        ...
                        <div class="xia">
                            <div class="zanneirong">
                                <div class="innerzancontent">
                                    <p>
                                        <a href="#" style="color:#D57D39">@小胖鱼</a>:
                                        <a href="#">
                                            <!--当条博客中的纯文字-->
                    ...
                    <td>
                        ...
                        <div class="xia">
                            <div class="zanneirong">
                                <div class="innerzancontent">
                                    <p>
                                        <a href="#" style="color:#D57D39">@阿欣</a>:
                                        <a href="#">
                                            <!--当条博客中的纯文字-->
                                            魔镜魔镜，这个世上谁最美
                                        </a>
                    ...
                    <td>
                        ...
                        <div class="xia">
                            <div class="zanneirong">
                                <div class="innerzancontent">
                                    <p>
                                        <a href="#" style="color:#D57D39">@Company_Xin</a>:
                                        <a href="#">
                                            <!--当条博客中的纯文字-->
                                            我最美​​​
                                        </a>
