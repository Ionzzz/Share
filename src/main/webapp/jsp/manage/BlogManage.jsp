    ...
    //$.extend($.fn.dataTable.defaults.oLanguage,oLanguage)
        ...
        <script>
            ...
            function deleteBlog(id){
                ...
                $.ajax({
                    url:"${pageContext.request.contextPath }/mngBlog/delete.action",
                    data:{"id":id},
                    success:function(){
                        alert("删除成功");
                        location.reload();
            ...
            $(document).ready(function () {
                ...
                "aaSorting":[[1,"desc"]],
                    "ajax":{
                        url:"${pageContext.request.contextPath }/mngBlog/show.action",
                        dataSrc: '',
//                        "dataType":"jsonp",
                    },
                    "columns":[
                        { "data": "blogContent"},
                        { "data": "blogCreateTime","render": function ( data, type, row, meta ) {
                            return new Date(data).toLocaleString();
                        }},
                        { "data": "blogBrowseCount","render": function ( data, type, row, meta ) {
                            return data;
                        }},
                        { "data": "blogId","render": function ( data, type, row, meta ) {
                            var delBtn = '<a href="javascript:void(0)" onclick="deleteBlog('+parseInt(data)+')">删除</a>'
                            return delBtn;
                        }},
                    ]
                });
