...
<body>
    ...
    <script>
        ...
        function deleteComment(id){
            ...
            $.ajax({
                url:"${pageContext.request.contextPath }/mngComment/delete.action",
                data:{"id":id},
                success:function(){
                    alert("删除成功");
                    location.reload();
        ...
        $(document).ready(function () {
            $('#dataTables-example').dataTable({
                ...
                "aaSorting":[[2,"desc"]],
                "ajax":{
                    url:"${pageContext.request.contextPath }/mngComment/show.action",
                    dataSrc: '',
//                        "dataType":"jsonp",
                },
                "columns":[
                    { "data": "content"},
                    { "data": "commenter"},
                    { "data": "commentTime","render": function ( data, type, row, meta ) {
                        return new Date(data).toLocaleString();
                    }},
                    { "data": "commentid","render": function ( data, type, row, meta ) {
                        var delBtn = '<a href="javascript:void(0)" onclick="deleteComment(\''+data+'\');">删除</a>'
                        return delBtn;
                    }},
                ]
            });
