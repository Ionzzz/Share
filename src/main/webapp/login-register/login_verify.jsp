...
<head>
    ...
    <title>Verity Login in Share</title>
                        ...
                        <form action="" method="">
                                ...
                                <div class="tab-pane" id="facilities">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-sm-offset-3">
                                            <a style="color:orange" href="<%=basePath%>/login-register/login_password.jsp">密码登录</a>
                                        </div>
                                        <div class="col-sm-4">
                            ...
                            <div class="wizard-footer">
                                <div class="pull-right">
                                    <input type='button' class='btn btn-finish btn-login btn-fill btn-primary btn-wd' id="login" name='login'
                                           style='background-color:#ff9800' value='登录'/>
                                </div>
                                <div class="pull-left">
