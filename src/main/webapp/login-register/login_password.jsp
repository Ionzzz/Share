...
<head>
    ...
    <title>Password Login in Share</title>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-sm-2 col-sm-offset-3">
                                        <a style="color:orange" href="<%=basePath%>/login-register/login_verify.jsp">验证码登陆</a>
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-2">
                                        <a style="color:orange" href="../jsp/login_forget.jsp">忘记密码?</a>
                                    </div>
                                </div>
                            </div>
